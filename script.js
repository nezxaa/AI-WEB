...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function sendMessage() {
        ...
        fetch("https://api.shapes.inc/v1/chat/completions", {
            ...
            body: JSON.stringify({
                model,
                messages: [{ role: "system", content: "You are Adel, a cheerful and friendly Japanese-Indonesian idol. Always reply as Adel would, casually and charming." }, ...messages.slice(-20)] // Send entire conversation history
            })
        })
        .then(res => res.json())
        .then(data => {
